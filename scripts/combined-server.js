...
app.use(async (req, res, next) => {
  ...
  // Serve static assets for SSR (non-app subdomains)
  if (!isAppSubdomain && (pathname.startsWith('/assets/') || pathname.includes('.'))) {
    ...
    if (isAppSubdomain) {
      ...
      if (pathname.startsWith('/assets/') || pathname.includes('.')) {
        ...
        const assetPath = existsSync(join(__dirname, '../build/spa/client'))
          ? join(__dirname, '../build/spa/client', pathname)
          : join(__dirname, '../spa/client', pathname);
