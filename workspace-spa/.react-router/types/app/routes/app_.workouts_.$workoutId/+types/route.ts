...
// routes/app_.workouts_.$workoutId/route.tsx
...
export type Info = {
  parents: [Parent0],
  id: "routes/app_.workouts_.$workoutId"
  file: "routes/app_.workouts_.$workoutId/route.tsx"
  path: "app/workouts/:workoutId"
  params: {"workoutId": string} & { [key: string]: string | undefined }
  module: Module
